...
from na_tools.daemon.socks import resolve_default_socks_bind_host
...
class DaemonSocksBindHostTest(unittest.TestCase):
    def test_default_socks_bind_host_uses_all_interfaces_for_host_gateway(self) -> None:
        self.assertEqual(resolve_default_socks_bind_host(), DEFAULT_SOCKS_BIND_HOST)
